...
$mail->Host = 'mail.niagara77.ca'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@niagara77.ca'; // SMTP username
$mail->Password = 'mail@niagara77'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('info@niagara77.ca', $_POST['name']);
$mail->addAddress('ghimireudbhav@gmail.com');

$mail->addReplyTo($_POST['email']);
$mail->isHTML(true);

$mail->Subject = "Niagara 77 - Landing Page Inquiry";
$message = '<html>
